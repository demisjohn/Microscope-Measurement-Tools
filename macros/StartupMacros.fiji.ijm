...
macro "Draw Rectangle Long Length Action Tool - L030bLf3fbL07f7" {
    run("Draw Rectangle Long Length");
}

macro "Draw Rectangle Short Length Action Tool - L303eLc0ceL37c7" {
    run("Draw Rectangle Short Length");
}

macro "Draw Rectangle Length x Width Action Tool - R00ffT3c07LT7c07,T9c07W" {
    run("Draw Rectangle Length x Width");
}

macro "Choose Microscope Calibration Action Tool - T0d14kT9d14X" {
    run("Choose Microscope Calibration");
}

macro "Draw Rectangle Long Length [q]" {
    run("Draw Rectangle Long Length");
}

macro "Draw Rectangle Short Length [g]" {
    run("Draw Rectangle Short Length");
}

macro "Draw Rectangle Length x Width [u]" {
    run("Draw Rectangle Length x Width");
}

macro "Choose Microscope Calibration [f1]" {
    run("Choose Microscope Calibration");
}